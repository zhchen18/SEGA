...
if EXTRACT_TEXT:
    ...
    np.save('./EATD-Features/train_text_bert_768.npy', train_features)
    np.save('./EATD-Features/valid_text_bert_768.npy', valid_features)
...
if EXTRACT_QUESTION:
    ...
    print('valid_features', valid_features.shape)
    #
    np.save('./EATD-Features/train_question_bert_768.npy', train_features)
    np.save('./EATD-Features/valid_question_bert_768.npy', valid_features)
